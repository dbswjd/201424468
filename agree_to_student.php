...
<div data-role="page" id="room_update" data-theme="b" >
  ...
  <div data-role="content">
    ...
    <div class="ui-grid-b">
      <div class="ui-block-a"><a href="room_detail.php?value=<?=$room_idx?>" data-role="button">보류</a></div>
      <div class="ui-block-b"><a href="process_agree.php?room_value=<?=$room_idx?>&applicant_value=<?=$applicant_idx?>&check=N" data-role="button">거부</a></div>
      <div class="ui-block-c"><a href="process_agree.php?room_value=<?=$room_idx?>&applicant_value=<?=$applicant_idx?>&check=Y" data-role="button">승인</a></div>
    </div>
  </div> 
</div>
</body>
